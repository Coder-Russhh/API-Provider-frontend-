  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Description Section */}
        <div className="text-gray-300 text-lg text-center mb-12">
          {/* <p>
            At Free.Large.API, we are committed to providing developers with high-quality, free APIs.<br/> Our goal is to offer robust data services that can be easily integrated into your projects without the need for complex setups.
          </p> */}
          <p className="mt-4">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-12">
          <h2 className="text-3xl font-semibold text-[#9bff52] mb-4">More Upcoming</h2>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-bold text-[#9bff52] mb-4">Want to Suggest an API?</h3>
