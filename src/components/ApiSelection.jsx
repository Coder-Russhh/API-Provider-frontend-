...
const ApiSelection = () => {
  return (
    <div className="bg-gray-900 min-h-screen text-white py-12">
      <h1 className="text-3xl sm:text-4xl font-bold text-center text-[#9bff52] mb-8 px-4">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        {apis.map((api) => (
          <Link to={`/api-select${api.query}`} key={api.id}>
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg hover:bg-gray-700 transition-colors duration-200 cursor-pointer text-center">
